...
-->
<html dir="ltr" mozdisallowselectionprint style="overflow-y: hidden">
<head>
    <meta charset="utf-8">
    ...
    <script src="../../../js/pdf.js/web/viewer.js"></script>
    ...
    <script src="<?php echo(CONFIG_SITE["baseURL"] . "/js/jquery-3.3.1.min.js"); ?>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#openFile, #viewBookmark, #secondaryViewBookmark").remove();
        });
    </script>
...
<body tabindex="1" class="loadingInProgress pdfReaderBody" style="margin-top: 45px">
<div id="outerContainer" style="height: calc(100vh - 45px)">

    <div id="sidebarContainer">
        <div id="toolbarSidebar" style="background-color: transparent">
    ...
    <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            <div id="secondaryToolbarButtonContainer">
                ...
                <button id="secondaryOpenFile" class="secondaryToolbarButton openFile visibleLargeView hidden"
                        title="Open File" tabindex="52" data-l10n-id="open_file" style="display: none">
        ...
        <div class="toolbar">
            <div id="toolbarContainer" style="background-color: transparent">
